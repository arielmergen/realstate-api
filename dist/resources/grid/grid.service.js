...
let GridService = class GridService {
    ...
    async create(_a) {
        var { slides, imageFolder } = _a, grid = __rest(_a, ["slides", "imageFolder"]);
        ...
        return await this.prisma.gridConfiguration.create({
            data: Object.assign(Object.assign({}, grid), { slides: {
    ...
    async update(id, _a) {
        var { slides, id: _, imageFolder } = _a, grid = __rest(_a, ["slides", "id", "imageFolder"]);
