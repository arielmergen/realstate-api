...
__decorate([
    ...
    (0, graphql_1.Mutation)('createOwner'),
    __param(0, (0, graphql_1.Args)('ownerInput')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [entities_1.OwnerInput]),
    __metadata("design:returntype", Promise)
], OwnerResolver.prototype, "create", null);
__decorate([
    (0, graphql_1.Query)('owners'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], OwnerResolver.prototype, "findAll", null);
__decorate([
    (0, graphql_1.Query)('owner'),
...
__decorate([
    (0, decorators_1.Roles)(entities_1.RolesName.Executive, entities_1.RolesName.Admin),
    (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard, guards_1.RolesGuard),
    (0, graphql_1.Mutation)('updateOwner'),
    __param(0, (0, graphql_1.Args)('id')),
    __param(1, (0, graphql_1.Args)('ownerInput')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, entities_1.OwnerInput]),
    __metadata("design:returntype", Promise)
], OwnerResolver.prototype, "update", null);
__decorate([
    (0, decorators_1.Roles)(entities_1.RolesName.Executive, entities_1.RolesName.Admin),
    (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard, guards_1.RolesGuard),
    (0, graphql_1.Mutation)('deleteOwner'),
    __param(0, (0, graphql_1.Args)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], OwnerResolver.prototype, "delete", null);
OwnerResolver = __decorate([
    (0, graphql_1.Resolver)('Owner'),
