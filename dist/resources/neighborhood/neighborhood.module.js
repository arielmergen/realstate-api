...
const neighborhood_resolver_1 = require("./neighborhood.resolver");
let NeighborhoodModule = class NeighborhoodModule {
};
NeighborhoodModule = __decorate([
    (0, common_1.Module)({
        providers: [neighborhood_resolver_1.NeighborhoodResolver, neighborhood_service_1.NeighborhoodService],
    })
], NeighborhoodModule);
